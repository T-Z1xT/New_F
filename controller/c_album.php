...
class c_album
{
    ...
    public function read_album($id) {
        $conn = new c_conn();
        $query = mysqli_query($conn->conn(), "SELECT * FROM album WHERE album_id = $id");
    ...
    public function update_album($id, $nama, $desc){
        $conn = new c_conn();
        $query = mysqli_query($conn->conn(), "UPDATE album SET NamaAlbum='$nama', Deskripsi='$desc' WHERE album_id = $id");
    }
    ...
    public function foto($albumid) {
        $conn = new c_conn();
        $query = mysqli_query($conn->conn(), "SELECT LokasiFile FROM foto WHERE album_id = $albumid");
